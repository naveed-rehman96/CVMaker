...
class TechnicalSkillsAdapterClass(
    val context1: Context,
    private val arrayList: ArrayList<SkillsEntity>,
    var onClicked: onExperienceClickedListener
) :
    RecyclerView.Adapter<TechnicalSkillsAdapterClass.MyViewHolder>() {
...
//
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.CName.text = modelClass.skillTitle
        val number = position +1
        holder.itemNumber.text = "Skill $number"
