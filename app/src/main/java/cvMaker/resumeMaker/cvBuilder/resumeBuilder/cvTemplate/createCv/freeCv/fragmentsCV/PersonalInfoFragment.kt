...
import cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.fragmentModelClass.PersonalInfoDataClass
...
class PersonalInfoFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        confirm.setOnClickListener {
            ...
            CreateCVActivity.mViewPager2.currentItem = 1
        }
...
//
        ...
        if (TextUtils.isEmpty(phoneNumber)) {
            ...
            if (cCPicker.isValid) {
                ...
                CreateCVActivity.showMessage("You have entered and Invalid Number...")
                phoneNumEdt.error = "Invalid"
            }
        }
        ...
        if (TextUtils.isEmpty(emailid)) {
            ...
            if (!isValidEmail(emailid)) {
                CreateCVActivity.showMessage("Email Not Saved .. Please Type Correct Email ...")
                emailID.error = "Invalid"
            } else {
