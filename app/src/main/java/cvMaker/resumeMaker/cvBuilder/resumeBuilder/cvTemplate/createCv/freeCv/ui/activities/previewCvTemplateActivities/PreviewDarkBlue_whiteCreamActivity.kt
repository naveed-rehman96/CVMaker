...
class PreviewDarkBlue_whiteCreamActivity : AppCompatActivity() {
    ...
    private fun getOPFile(): File? {
        ...
        return File(mediaStorageDir.path + File.separator + modelMain.personInfo.fileName + "_DBWC.jpg")
    }
    ...
    fun previewCV() {
        ...
        htmlContent.append(
            String.format(
                "<!DOCTYPE html>\n" +
                    ...
                    ".c9{padding-top: 6pt; padding-bottom: 6pt; background: #163C60; margin-right: 20pt; margin-left: 20pt; border-radius: 5pt; color: #ffffff text-align: center}" +
                    ...
                    ".c91{line-height: 1.15; color: #ffffff; padding: 10px; margin-right: 50pt; border-radius: 10pt; background: #163C60}" +
        ...
        if (modelMain.personInfo.imagePath.equals("")) {
            if (modelMain.personInfo.gender.equals("Male")) {
                htmlContent.append(
                    String.format(
                        " <div style=\"height: 200px; background: #163C60;align-items: center;\">\n" +
        ...
        if (!tinyDB.getBoolean(Constants.skipLang)) {
            ...
            htmlContent.append(
                String.format(
                    " <p class=\"c6\" style=\"margin-bottom: 4px;\">" +
                        "<span class=\"c7\">%s</span>" +
                        "</p>" +
                        "        <p class=\"68\"></p>",
        ...
        htmlContent.append(
            String.format(
                " <div style=\"height: 190px;margin: 15pt;border-radius: 10pt; align-items: center; background:#163C60;\">" +
                    "                            <p class=\"c68\"></p>" +
                    "                            <p class=\"c68\"></p>" +
                    "                            <p class=\"c68\"></p>" +
                    "                            <p class=\"c68\"></p>" +
