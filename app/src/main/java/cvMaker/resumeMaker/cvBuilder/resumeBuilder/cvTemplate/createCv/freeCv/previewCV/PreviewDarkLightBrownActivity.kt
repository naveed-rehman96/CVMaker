...
class PreviewDarkLightBrownActivity : AppCompatActivity() {
    ...
    private fun savePdf() {
        ...
        if (ActivityCompat.checkSelfPermission(
            ...
            val fileName = modelMain.personInfo.fileName + "_" + modelMain.personInfo.getId() + "_BCC.pdf"
    ...
    private fun getOPFile(): File? {
        ...
        return File(mediaStorageDir.path + File.separator + modelMain.personInfo.fileName + "_DLBCS.jpg")
    }
    ...
    fun previewCV() {
        ...
        htmlContent.append(
            String.format(
                "<!DOCTYPE html>\n" +
                        ...
                        ".c4 {border-right-style: solid; border-bottom-color: #F3EFDF; border-top-width: 0pt;border-right-width: 0pt; margin-top: 20pt; border-left-color: #F3EFDF;vertical-align: top; border-right-color: #F3EFDF;border-left-width: 0pt; border-top-style: solid; border-left-style: solid; border-bottom-width: 0pt;background: #F3EFDF; width: 327.7pt;border-top-color: #F3EFDF; border-bottom-style: solid}" +
                        ".c26 {           border-right-style: solid; border-bottom-color: #9B8271; border-top-width: 0pt; border-right-width: 0pt; border-left-color: #9B8271; vertical-align: top; border-right-color: #9B8271; border-left-width: 0pt; background: #9B8271; border-top-style: solid; border-left-style: solid; border-bottom-width: 0pt; width: 176.3pt;border-top-color: #9B8271; border-bottom-style: solid}" +
                        ...
                        ".c20{color: #9B8271; font-weight: 700; text-decoration: none; vertical-align: baseline; font-size: 16pt; text-align: center; font-family: \"Raleway\"; font-style: normal}" +
                        ...
                        ".c9{padding-top: 0pt; padding-bottom: 0pt; background: #9B8271; margin-right: 20pt; margin-left: 20pt; text-align: center}" +
                        ...
                        ".c91{line-height: 1.15;            color: #ffffff;            border-radius: 10pt;            background: #F3EFDF}" +
                        ...
                        ".subtitle{padding-top: 3pt; color: #9B8271; font-weight: 700; font-size: 16pt; padding-bottom: 0pt; font-family: \"Raleway\"; line-height: 1.0; page-break-after: avoid; orphans: 2; margin-left: 20pt; widows: 2; text-align: left}" +
        ...
        htmlContent.append(
            String.format(
                "                    <td class=\"c4\" colspan=\"1\" rowspan=\"1\">\n" +
                        ...
                        "                        <p class=\"c68\"></p>\n" +
                        "                        <p class=\"c68\"></p>\n",
                modelMain.personInfo.getFullName(),
                modelMain.personInfo.getFatherName()
        ...
        if (!tinyDB.getBoolean(Constants.skipExp)) {
            if (modelMain.experienceInfo?.isEmpty() != true) {
                htmlContent.append(
                    String.format(
                        "<h1 class=\"c91\" >" +
        ...
        if (!tinyDB.getBoolean(Constants.skipQua)) {
            if (modelMain.qualificationEntity != null) {
                htmlContent.append(
                    String.format(
                        "<h1 class=\"c91\" >" +
                                "                            <span class=\"c33 subtitle\" >Education and Qualification</span>" +
                                "                            <hr class=\"new6\">" +
                                "                        </h1>" +
                                ""
                    )
