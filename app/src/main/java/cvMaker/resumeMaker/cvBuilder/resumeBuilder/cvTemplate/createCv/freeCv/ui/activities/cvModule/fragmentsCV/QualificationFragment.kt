...
class QualificationFragment : Fragment() , QualificationAdapterClass.onQualificationClickedListener {
    ...
    override fun onCreateView(
        ...
        btnNext.setOnClickListener {
            cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.ui.activities.cvModule.CreateCVActivity.mViewPager2.setCurrentItem(4, false)
        }
        btnBack.setOnClickListener{
            cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.ui.activities.cvModule.CreateCVActivity.mViewPager2.setCurrentItem(2,false)
        }
    ...
    private fun saveQualification(experienceModelClass: ArrayList<QualificationModelClass>) {
        ...
        cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.ui.activities.cvModule.CreateCVActivity.mViewPager2.currentItem
