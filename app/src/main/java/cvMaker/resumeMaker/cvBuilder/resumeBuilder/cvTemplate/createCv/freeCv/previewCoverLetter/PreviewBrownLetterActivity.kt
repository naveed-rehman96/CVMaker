package cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.previewCoverLetter
...
class PreviewBrownLetterActivity : AppCompatActivity() {
    ...
    private fun savePdf() {
        ...
        if (ActivityCompat.checkSelfPermission(
            ...
            val fileName = modelMain.cfilename+"_"+ modelMain.getCid()+"_BL.pdf"
    ...
    private fun getOPFile(): File? {
        ...
        return File(mediaStorageDir.path + File.separator + modelMain.cfilename+"_BL.jpg")
    }
    ...
    fun previewCV() {
        htmlContent.append(
            String.format(
                "<!DOCTYPE html>\n" +
                        ...
                        ".c26 {width: 500pt;border-right-style: solid; border-bottom-color: #ffffff; border-top-width: 0pt; border-right-width: 0pt border-left-color: #ffffff; vertical-align: top; border-right-color: #ffffff; border-left-width: 0pt; background: #ffffff; border-top-style: solid; border-left-style: solid; border-bottom-width: 0pt; border-top-color: #ffffff; border-bottom-style: solid}\n" +
                        ...
                        ".c4{ width: 50pt;border-right-style: solid;            border-bottom-color: #4A3727;            border-top-width: 0pt;            border-right-width: 0pt;            margin-top: 20pt;            border-left-color: #4A3727;            vertical-align: top;            border-right-color: #4A3727;            border-left-width: 0pt;            border-top-style: solid;            border-left-style: solid; border-bottom-width: 0pt; background: #4A3727;border-top-color: #4A3727;            border-bottom-style: solid}" +
        ...
        htmlContent.append(String.format(
            "" +
                    " <h1 class=\"c9\" style=\" text-align: left;margin-top: 20pt; margin-left: 15pt\">" +
                    "                            <span class=\"c16\" style=\"color: #4A3727;font-size: 30pt; margin-bottom: 10px;text-align: right;\">%s</span>" +
                    "                        </h1>" +
        ...
        htmlContent.append(String.format(
            "" +
                    "                        <h1 style=\" text-align: right;margin-top: 10pt;\">" +
                    "                            <span style=\"font-size: 30pt;color: #4A3727;text-align: right; margin-right: 30pt;\">%s</span>" +
                    "                        </h1>" +
                    "                        <hr style=\"background: #4A3727;margin-right: 30pt;margin-left: 30pt;\">"
        ,
        ...
        htmlContent.append(String.format(
            "" +
                    "<h1 class=\"c9\" style=\"height: 320pt;width:500pt;margin-top: 15pt;text-align: left; margin-right: 25pt;margin-left: 30pt\">" +
                    "                            <span class=\"c16\" style=\" line-height: 2.0;color: #4A3727; margin: 10pt;text-align: left;padding-right: 20pt\">" +
                    "                                %s</span>" +
                    "                        </h1>" +
                    ""  ,
        ...
        htmlContent.append(String.format(
            "" +
                    "" +
                    "                        <h1 style=\" text-align: right;margin-right: 30pt;\">" +
                    "                            <span style=\"font-size: 12pt;color: #4A3727; margin-bottom: 10px;text-align: right; margin-right: : 30pt;\">%s</span>" +
                    "                        </h1>" +
                    "                        <h1 style=\" text-align: right;margin-top: -8pt;\">" +
                    "                            <span style=\"font-size: 12pt;color: #4A3727; margin-bottom: 10px;text-align: right; margin-right: 30pt;\">%s</span>" +
                    "                        </h1>" +
                    "                        <h1 style=\" text-align: right;margin-top: -8pt;\">" +
                    "                            <span style=\"font-size: 12pt;color: #4A3727; margin-bottom: 10px;text-align: right; margin-right: 30pt;\">%s</span>" +
                    ...
                    "                            <span style=\" text-decoration: overline;font-size: 12pt;color: #4A3727; margin-bottom: 10px;text-align: left; margin-left: 15pt\">" +
                    "                                ( Signature )" +
                    "                            </span>" +
                    "                        </h3>" +
                    "                        <h3 style=\" text-align: left;margin-top: -8pt;margin-left: 30pt;\">" +
                    "                            <span style=\"font-size: 12pt;color: #4A3727; margin-bottom: 10px;text-align: left; margin-left: 15pt\">" +
                    "                                Date: %s" +
                    "                            </span>" +
                    "                        </h3>",
            modelMain.getReceiverName(), modelMain.getReceiverAddress() , modelMain.getReceiverDesignation() , modelMain.getDate()
        ))

        htmlContent.append(String.format(
            "" +
                    "                        <h1 style=\" text-align: right;margin-right: 30pt;\">" +
                    "                            <i class=\"fa fa-phone\" aria-hidden=\"true\" style=\"text-align: right;margin-right: 10px;color: #4A3727;\">" +
                    "                                <span class=\"c25\" style=\"color: #4A3727;margin-left: 5pt;\">%s</span></i>" +
                    "                        </h1>" +
                    "                        <h1 style=\" text-align: right;margin-right: 30pt;\">" +
                    "                            <i class=\"fa fa-envelope\" aria-hidden=\"true\" style=\"text-align: right;margin-right: 10px;color: #4A3727;\">" +
                    "                                <span class=\"c25\" style=\"color: #4A3727;margin-left: 5pt;\">%s</span></i>" +
                    "                        </h1>                     " +
                    "                        <h1 class=\"footer\">" +
                    "                        </h1>" +
                    ""  ,
            modelMain.getSenderPhone(),
            modelMain.getSenderEmail()
        ))
