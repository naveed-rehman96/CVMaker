...
class PreviewlightWhiteActivity : AppCompatActivity() {
    ...
    private fun getOPFile(): File? {
        ...
        return File(mediaStorageDir.path + File.separator + modelMain.personInfo.fileName + "_LWCVLW.jpg")
    }
    ...
    fun previewCV() {
        htmlContent.append(
            String.format(
                "<!DOCTYPE html>\n" +
                    ...
                    ".c26{border-right-style: solid; border-bottom-color: #F3F4F5; border-top-width: 0pt; border-right-width: 0pt; border-left-color: #F3F4F5; vertical-align: top; border-right-color: #F3F4F5; border-left-width: 0pt; background: #F3F4F5; border-top-style: solid; border-left-style: solid; border-bottom-width: 0pt; width: 176.3pt; border-top-color: #F3F4F5; border-bottom-style: solid}" +
                    ...
                    ".c16{color: #464646; font-weight: 700; text-decoration: none; vertical-align: baseline; font-size: 14pt; font-family: \"Raleway\"; font-style: normal}" +
                    ".c7{font-size: 10pt;            font-family: \"Lato\";            text-align: center}" +
                    ...
                    ".c6{padding-bottom: 0pt; line-height: 1.0; margin-left: 15pt; color: #464646; margin-right: 15pt; text-align: left}" +
                    ...
                    ".c9{padding-top: 5pt; padding-bottom: 5pt; background: #F3F4F5; margin: 0pt; color: #464646; text-align: center}" +
                    ...
                    ".c161{  color: #363636; font-weight: bolder; font-size: 18pt; background: #ffffff; font-family: \"Raleway\"}" +
                    ".c68{    padding-bottom: 10pt;    line-height: 1.0;    text-align: left;}" +

                    ".title{  padding-top: 6pt; color: #363636; font-weight: 700; font-size: 30pt; padding-bottom: 0pt; font-family: \"Raleway\"; line-height: 1.0; page-break-after: avoid; orphans: 2; margin-left: 20pt; widows: 2; text-align: left}" +
                    ".subtitle{padding-top: 3pt; color: #0084FF; font-weight: 700; font-size: 16pt; padding-bottom: 0pt; font-family: \"Raleway\"; line-height: 1.0; page-break-after: avoid; orphans: 2; widows: 2; margin-left: 20pt}" +
                ...
                htmlContent.append(
                    String.format(
                        "<p class=\"c68\"></p>" +
                            "<p class=\"c68\"></p>" +
                            "<p class=\"c68\"></p>" +
                            "<img src=\"%s\" style=\"border: 2px solid #fff;" +
                            "border-color: #ffffff;border-width: 5pt; width: 150px; height: 150px; margin-left: 10px;border-radius: 100px; margin-right: 10px;\">\n",
                        male
            ...
            htmlContent.append(
                String.format(
                    "<p class=\"c68\"></p>" +
                        "<p class=\"c68\"></p>" +
                        "<p class=\"c68\"></p>" +
                        "<img src=\"file://%s\" style=\"border: 2px solid #fff;" +
                        "border-color: #ffffff;border-width: 5pt; width: 150px; height: 150px; margin-left: 10px;border-radius: 100px; margin-right: 10px;\">\n",
                    file.absolutePath
        ...
        htmlContent.append(
            String.format(
                " <h1 class=\"c9\" style=\"text-align: center; margin-bottom: 15px;\">" +
                    "<span class=\"c16\" style=\" margin-bottom: 10px;text-align: center;\">Objective</span>\n" +
                    "                        </h1>\n" +
                    "\n"
            )
        )
        ...
        htmlContent.append(
            String.format(
                " <p class=\"c6\" style=\"margin-bottom: 8px;\"><span class=\"c7\">%s</span></p>",
            ...
            if (modelMain.skillsEntity != null) {
                htmlContent.append(
                    kotlin.String.format(
                        " <h1 class=\"c9\" style=\"text-align: center; margin-bottom: 15px;\">" +
                            "<span class=\"c16\" style=\" margin-bottom: 10px;text-align: center;\">Skills</span>\n" +
                            "                        </h1>\n" +
                            "\n"
                    )
                )
        ...
        if (!tinyDB.getBoolean(Constants.skipLang)) {
            htmlContent.append(
                String.format(
                    " <h1 class=\"c9\" style=\"text-align: center; margin-bottom: 15px;\">" +
                        "<span class=\"c16\" style=\" margin-bottom: 10px;text-align: center;\">Languages</span>\n" +
                        "                        </h1>\n" +
                        "\n"
                )
            )
            ...
            htmlContent.append(
                String.format(
                    " <p class=\"c6\" style=\"margin-bottom: 8px;\">" +
                        "<span class=\"c7\">%s</span>" +
                        "</p>",
        ...
        if (!tinyDB.getBoolean(Constants.skipInterest)) {
            htmlContent.append(
                String.format(
                    " <h1 class=\"c9\" style=\"text-align: center; margin-bottom: 15px;\">" +
                        "<span class=\"c16\" style=\" margin-bottom: 10px;text-align: center;\">Interest</span>\n" +
                        "                        </h1>\n" +
                        "\n"
                )
            )
        ...
        if (!tinyDB.getBoolean(Constants.skipAwards)) {
            htmlContent.append(
                String.format(
                    " <h1 class=\"c9\" style=\"text-align: center; margin-bottom: 15px;\">" +
                        "<span class=\"c16\" style=\" margin-bottom: 10px;text-align: center;\">Achievements</span>\n" +
                        "                        </h1>\n" +
                        "\n"
                )
            )
        ...
        if (!tinyDB.getBoolean(Constants.skipRef)) {
            htmlContent.append(
                String.format(
                    " <h1 class=\"c9\" style=\"text-align: center; margin-bottom: 15px;\">" +
                        "<span class=\"c16\" style=\" margin-bottom: 10px;text-align: center;\">Reference</span>\n" +
                        "                        </h1>\n" +
                        "\n"
                )
            )
                ...
                htmlContent.append(
                    String.format(
                        "                        <h1 class=\"c91\" style=\"margin-left: 20px;\">\n" +
                            "                            <span class=\"c161\" style=\"border-radius: 5pt;padding-right: 15pt;padding-top: 5pt;padding-bottom: 5pt;\">Experience</span>\n" +
                            "                        </h1>\n"
                    )
                )
            }
                    ...
                    htmlContent.append(
                        String.format(
                            "<h2 class=\"c3\" style=\"font-size: 12px; margin-top: 2px;font-style: bold;margin-bottom: 5px;margin-left: 28pt\">\n" +
                                ...
                                "                        <p class=\"c221\" style=\"border-radius: 5px;width: 120pt;background: #0084FF;padding: 3pt;font-size: 7pt;margin-top: 2px;margin-left: 28pt\">%s</p>\n" +
                                "\n",
                            model.companyName,
                            model.designation,
                    ...
                    htmlContent.append(
                        String.format(
                            "<h2 class=\"c3\" style=\"font-size: 12px; margin-top: 2px;font-style: bold;margin-bottom: 5px;margin-left: 28pt\">\n" +
                                ...
                                "                        </p>\n" +
                                "                        <p class=\"c221\" style=\"border-radius: 5px;width: 35pt;background: #0084FF;padding: 3pt;font-size: 7pt;margin-top: 2px;margin-left: 28pt\">%s</p>\n" +
                                "\n",
                            model.schoolName,
                            model.subject,
                            model.marks,
                ...
                for (model in modelMain.projectsEntity!!) {
                    htmlContent.append(
                        kotlin.String.format(
                            "                         <p class=\"c22\">\n" +
                                "                            <span>\n" +
                                "                                <p style=\"font-size: 10pt;color: #2F3A40;margin-top: 2px;padding-right: 15pt;margin-bottom: 0px;margin-left: 28pt;font-weight:bold;\">%s</p>\n" +
                                "                            </span>\n" +
                                "                        </p>\n",
                            model.projectTitle
    ...
    private fun savePdf() {
        ...
        if (ActivityCompat.checkSelfPermission(
            ...
            val fileName = modelMain.personInfo.fileName + "_" + modelMain.personInfo.id + "_LW.pdf"
