...
class QualificationFragment : Fragment() , QualificationAdapterClass.onQualificationClickedListener {
    ...
    override fun onCreateView(
        ...
        btnBack.setOnClickListener{
            cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.cvModule.CreateCVActivity.mViewPager2.setCurrentItem(2,false)
        }
    ...
    private fun saveQualification(experienceModelClass: ArrayList<QualificationModelClass>) {
        ...
        cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.cvModule.CreateCVActivity.mViewPager2.currentItem
