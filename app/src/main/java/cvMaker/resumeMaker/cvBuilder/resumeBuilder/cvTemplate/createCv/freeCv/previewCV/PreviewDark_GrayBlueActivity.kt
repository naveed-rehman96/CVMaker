...
class PreviewDark_GrayBlueActivity : AppCompatActivity() {
    ...
    private fun getOPFile(): File? {
        ...
        return File(mediaStorageDir.path + File.separator + modelMain.personInfo.fileName + "_DGB.jpg")
    }
    ...
    fun previewCV() {
        ...
        if (modelMain.personInfo.imagePath.equals("")) {
            if (modelMain.personInfo.imagePath.equals("Male")) {
                htmlContent.append(
                    String.format(
                        "" +
            ...
            } else if (modelMain.personInfo.imagePath.equals("Female")) {
                    htmlContent.append(
                        String.format(
                            "" +
                                    "<img src=\"%s\" style=\"width: 150px; height: 150px; margin-left: 10px;border-radius: 100%%; margin-right: 10px;\">\n",
    ...
    private fun savePdf() {
        ...
        if (ActivityCompat.checkSelfPermission(
            ...
            val fileName = modelMain.personInfo.fileName + "_" + modelMain.personInfo.id + "_DGB.pdf"
