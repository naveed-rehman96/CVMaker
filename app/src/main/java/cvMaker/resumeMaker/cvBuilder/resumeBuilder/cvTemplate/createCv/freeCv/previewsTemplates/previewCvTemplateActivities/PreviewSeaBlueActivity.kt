...
class PreviewSeaBlueActivity : AppCompatActivity() {
    ...
    private fun getOPFile(): File? {
        ...
        return File(mediaStorageDir.path + File.separator + modelMain.personInfo.fileName + "_CBCSEA.jpg")
    }
    ...
    fun previewCV() {
        ...
        htmlContent.append(
            String.format(
                "<!DOCTYPE html>\n" +
                    ...
                    ".c26{border-right-style: solid; border-bottom-color: #E7E3E3; border-top-width: 0pt; border-right-width: 0pt; border-left-color: #E7E3E3; vertical-align: top; border-right-color: #E7E3E3; border-left-width: 0pt; background: #E7E3E3; border-top-style: solid; border-left-style: solid; border-bottom-width: 0pt; width: 176.3pt; border-top-color: #E7E3E3; border-bottom-style: solid}" +
                    ...
                    ".c16{color: #ffffff; font-weight: 700; text-decoration: none; vertical-align: baseline; font-size: 14pt; font-family: \"Raleway\"; font-style: normal}" +
                    ".c7{color: #000000;            font-size: 10pt;            font-family: \"Lato\";            text-align: center}" +
                    ...
                    ".c9{padding-top: 6pt; padding-bottom: 6pt; background: #5EA3DA; margin-right: 20pt; margin-left: 20pt; border-radius: 5pt; color: #ffffff text-align: center}" +
                    ...
                    ".c91{line-height: 1.15; color: #ffffff; padding: 10px; margin-right: 50pt; border-radius: 10pt; background: #5EA3DA}" +
                    ".c161{color: #ffffff;            font-weight: 100;            font-size: 12pt;            font-family: \"Raleway\"}" +
                    ".c68{    padding-bottom: 10pt;    line-height: 1.0;    text-align: left;}" +
                    ".triangle-down { width: 0; height: 0; border-left: 88pt solid transparent; border-right: 88pt solid transparent; border-top: 50pt solid #5EA3DA; }" +

                    ".title{padding-top: 6pt; color: #ffffff; font-weight: 700; font-size: 25pt; padding-bottom: 0pt; font-family: \"Raleway\"; line-height: 1.0; page-break-after: avoid; orphans: 2; widows: 2; text-align: left}" +
        ...
        if (modelMain.personInfo.imagePath.equals("")) {
            if (modelMain.personInfo.gender.equals("Male")) {
                htmlContent.append(
                    String.format(
                        " <div style=\"height: 200px; background: #5EA3DA;align-items: center;\">\n" +
        ...
        htmlContent.append(
            String.format(
                "                        <p class=\"c68\"></p>" +
                    ...
                    "                            <span class=\"c16\" style=\"font-size:14pt;color: #ffffff; margin-bottom: 10px;text-align: center;\">Contact Details</span>" +
                    "                        </h1>" +
                    "                        <p class=\"c68\"></p>"
            )
        )
        ...
        htmlContent.append(
            String.format(
                "                        <p class=\"c6\"><span class=\"c7\">%s</span></p>\n" +
                    ...
                    "                            <span class=\"c25\" style=\"color: #000000;\">%s</span>\n" +
                    "                        </p>\n" +
        ...
        if (!tinyDB.getBoolean(Constants.skipTech)) {
            ...
            for (model in modelMain.skillsEntity!!) {
                htmlContent.append(
                    kotlin.String.format(
                        " <p class=\"c6\" style=\"margin-bottom: 3px;\">" +
        ...
        if (!tinyDB.getBoolean(Constants.skipAwards)) {
            htmlContent.append(
                String.format(
                    " <h1 class=\"c9\" style=\"text-align: center; margin-bottom: 15px;\">" +
                        "<span class=\"c16\" style=\"color: #ffffff; margin-bottom: 10px;text-align: center;\">Awards</span>\n" +
                        "                        </h1>\n" +
                        "\n"
                )
            )
        ...
        htmlContent.append(
            String.format(
                " <div style=\"height: 190px;margin: 15pt;border-radius: 10pt; align-items: center; background:#5EA3DA;\">" +
                    "                            <p class=\"c68\"></p>" +
                    "                            <p class=\"c68\"></p>" +
                    "                            <p class=\"c68\"></p>" +
                    "                            <p class=\"c68\"></p>" +
        ...
        htmlContent.append(
            String.format(
                "                        <h1 class=\"c91\" style=\"margin-left: 20px;\">\n" +
                    "                            <span class=\"c161\" style=\"border-radius: 5pt;padding-left: 15pt;padding-right: 15pt;padding-top: 5pt;padding-bottom: 5pt;\">Objective</span>\n" +
                    "                        </h1>\n"
            )
        )
        htmlContent.append(
    ...
    private fun savePdf() {
        ...
        if (ActivityCompat.checkSelfPermission(
            ...
            val fileName = modelMain.personInfo.fileName + "_" + modelMain.personInfo.id + "_DBWC.pdf"
