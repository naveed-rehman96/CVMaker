...
class LanguageFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        btnNext.setOnClickListener {
            ...
            cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.ui.activities.cvModule.CreateCVActivity.mViewPager2.setCurrentItem(9,true)
        }
        btnBack.setOnClickListener{
            cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.ui.activities.cvModule.CreateCVActivity.mViewPager2.setCurrentItem(7,true)
        }
    ...
    private fun updateLanguage(languageTxt: String) {
        ...
        cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.ui.activities.cvModule.CreateCVActivity.xModel.language = languageTxt
    }
