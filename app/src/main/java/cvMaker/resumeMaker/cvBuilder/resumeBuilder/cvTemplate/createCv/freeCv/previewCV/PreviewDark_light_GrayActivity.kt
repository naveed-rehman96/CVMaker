...
class PreviewDark_light_GrayActivity : AppCompatActivity() {
    ...
    private fun getOPFile(): File? {
        ...
        return File(mediaStorageDir.path + File.separator + modelMain.personInfo.fileName + "_DLG.jpg")
    }
    ...
    fun previewCV() {
        ...
        htmlContent.append(
            String.format(
                "<!DOCTYPE html>\n" +
                        ...
                        ".c9{padding-top: 6pt; padding-bottom: 6pt; background-image: linear-gradient(to right, #78A1B4, #447888); margin-right: 20pt; border-top-right-radius: 5pt; border-bottom-right-radius: 5pt; margin-left: -10pt; color: #ffffff text-align: center}" +
                        ...
                        ".c91{line-height: 1.15; color: #ffffff; padding: 10px; margin-right: 50pt; border-radius: 10pt; background-image: linear-gradient(to right, #78A1B4, #447888);}" +
        ...
        htmlContent.append(
            String.format(
                "<tr class=\"c21\">\n" +
                        ...
                        "                        <div style=\"width: 30pt;height: 190px;background: #78A1B4;\"> </div>" +
                        "           </td>" +
        ...
        htmlContent.append(
            String.format(
                " <h1 class=\"c9\" style=\"text-align: center; margin-bottom: 15px;\">" +
                        "<span class=\"c16\" style=\"color: #ffffff; margin-bottom: 10px;text-align: center;\">Objective</span>\n" +
                        "                        </h1>\n" +
                        "\n"
            )
        )
        ...
        htmlContent.append(
            String.format(
                " <div style=\"height: 190px;border-bottom-right-radius: 75px; align-items: center; background-image: linear-gradient(to right, #78A1B4, #447888);\">" +
                        "                            <p class=\"c68\"></p>" +
                        "                            <p class=\"c68\"></p>" +
                        "                            <p class=\"c68\"></p>" +
                        "                            <p class=\"c68\"></p>" +
                ...
                htmlContent.append(
                    String.format(
                        "                        <h1 class=\"c91\" style=\"margin-left: 20px;\">\n" +
                                "                            <span class=\"c16\" style=\"border-radius: 5pt;padding-left: 15pt;padding-right: 15pt;padding-top: 5pt;padding-bottom: 5pt;\">Experience</span>\n" +
                                "                        </h1>\n"
                    )
                )
            }
            ...
            if (modelMain.qualificationEntity != null) {
                htmlContent.append(
                    String.format(
                        "  <p class=\"c68\"></p>\n" +
                                "                        <h1 class=\"c91\" style=\"margin-left: 20px;\">\n" +
                                "                            <span class=\"c16\" style=\"border-radius: 5pt;padding-left: 15pt;padding-right: 15pt;padding-top: 5pt;padding-bottom: 5pt;\">Qualification</span>\n" +
                                "                        </h1>\n" +
                                "\n"
                    )
                )
            ...
            if (modelMain.projectsEntity != null) {
                htmlContent.append(
                    String.format(
                        "  <p class=\"c68\"></p>\n" +
                                "                        <h1 class=\"c91\" style=\"margin-left: 20px;\">\n" +
                                "                            <span class=\"c16\" style=\"border-radius: 5pt;padding-left: 15pt;padding-right: 15pt;padding-top: 5pt;padding-bottom: 5pt;\">Projects</span>\n" +
                                "                        </h1>\n" +
                                "\n"
                    )
                )
