...
class LightGrayWhiteCvFragment : Fragment() {
            ...
            if (modelMain.skillsEntity != null) {
                htmlContent.append(
                    java.lang.String.format(
                        "" +
                            "                        <h1 class=\"c9\">" +
                            "                            <span class=\"c16\" style=\"margin-left: 20pt;\">Technical Skills</span>" +
                            "                        </h1>" +
                            "                            <hr class=\"hr.new6\" style=\"width: 160pt;text-align: center;\">"
        ...
        if (!tinyDB.getBoolean(Constants.skipAwards)) {
            htmlContent.append(
                String.format(
                    "" +
                        "<h1 class=\"c91\" >" +
                        "                            <span class=\"33 subtitle\" style=\"margin-top: 10pt;text-decoration: underline;text-underline-position: under;\">  Achievements  </span>" +
                        "                        </h1>" +
                        "                        <p class=\"c6\" style=\"margin-bottom: 15px;\">" +
                        "                            <span class=\"c7\">%s</span>" +
                        "                        </p>" +
