            ...
            RadioGroup.OnCheckedChangeListener { _, checkedId ->
                ...
                when (checkedId) {
                    ...
                    R.id.yellow_theme_rb -> {
                        ...
                        settingsToolbar.setBackgroundColor(ContextCompat.getColor(this , R.color.Yellow_Theme))
                    ...
                    R.id.orange_theme_rb -> {
                        ...
                        settingsToolbar.setBackgroundColor(ContextCompat.getColor(this , R.color.Orange_Theme))
                    ...
                    R.id.green_theme_rb -> {
                        ...
                        settingsToolbar.setBackgroundColor(ContextCompat.getColor(this , R.color.Green_Theme))
