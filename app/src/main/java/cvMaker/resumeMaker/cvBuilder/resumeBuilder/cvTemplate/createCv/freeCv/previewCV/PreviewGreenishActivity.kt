...
class PreviewGreenishActivity : AppCompatActivity() {
    ...
    private fun getOPFile(): File? {
        ...
        return File(mediaStorageDir.path + File.separator + modelMain.personInfo.fileName + "_GRNCV.jpg")
    }
    ...
    fun previewCV() {
        htmlContent.append(
            String.format(
                "<!DOCTYPE html>\n" +
                        ...
                        ".c26{border-right-style: solid; border-bottom-color: #51C140; border-top-width: 0pt; border-right-width: 0pt; border-left-color: #51C140; vertical-align: top; border-right-color: #51C140; border-left-width: 0pt; background: #51C140; border-top-style: solid; border-left-style: solid; border-bottom-width: 0pt; width: 190.3pt; border-top-color: #51C140; border-bottom-style: solid}" +
                        ...
                        ".c16{ color: #ffffff; font-weight: 700; text-decoration: none; vertical-align: baseline; font-size: 16pt; font-family: \"Raleway\"; font-style: normal}" +
                        ...
                        ".c9{padding-top: 0pt; padding-bottom: 0pt; background: #51C140; margin-right: 20pt; margin-left: 20pt;}" +
                        ...
                        ".c161{ olor: #000000;            font-weight: 100;           font-size: 12pt;            font-family: \"Raleway\"}" +
                        ...
                        ".subtitle{padding-top: 3pt; color: #51C140; font-weight: 700; font-size: 16pt; padding-bottom: 0pt; font-family: \"Raleway\"; line-height: 1.0; page-break-after: avoid; orphans: 2; margin-left: 20pt; widows: 2; text-align: left}" +
                ...
                htmlContent.append(
                    kotlin.String.format(
                        " <h1 class=\"c9\" style=\"margin-bottom: 15px;\">" +
                                "<span class=\"c16\" style=\" margin-bottom: 10px;\">Skills</span>\n" +
                                "                        </h1>\n" +
                                "\n"
                    )
                )
        ...
        if (!tinyDB.getBoolean(Constants.skipLang)) {
            htmlContent.append(
                String.format(
                    " <h1 class=\"c9\" style=\" margin-bottom: 15px;\">" +
                            "<span class=\"c16\" style=\" margin-bottom: 10px;\">Languages</span>\n" +
                            "                        </h1>\n" +
                            "\n"
                )
            )
        ...
        if (!tinyDB.getBoolean(Constants.skipProj)) {
            ...
            if (modelMain.projectsEntity != null) {
                htmlContent.append(
                    kotlin.String.format(
                        " <h1 class=\"c9\" style=\"margin-bottom: 15px;\">" +
                                "<span class=\"c16\" style=\" margin-bottom: 10px;\">Projects</span>\n" +
                                "                        </h1>\n" +
                                "\n"
                    )
                )
        ...
        htmlContent.append(
            String.format(
                ...
                modelMain.personInfo.fatherName, modelMain.personInfo.objective
    ...
    private fun savePdf() {
        ...
        if (ActivityCompat.checkSelfPermission(
            ...
            val fileName = modelMain.personInfo.fileName + "_" + modelMain.personInfo.id + "_DRW.pdf"
