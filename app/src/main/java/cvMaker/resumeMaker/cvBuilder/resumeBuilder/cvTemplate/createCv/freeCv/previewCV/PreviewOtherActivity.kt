...
class PreviewOtherActivity : AppCompatActivity() {
    ...
    private fun getOPFile(): File? {
        ...
        return File(mediaStorageDir.path + File.separator + modelMain.personInfo.fileName + "_LGWOTH.jpg")
    }
        ...
        htmlContent.append(
            String.format(
                "<!DOCTYPE html>\n" +
                        ...
                        ".c26{border-right-style: solid;border-bottom-color: #EC7E74;            border-top-width: 0pt;           border-right-width: 0pt;           border-left-color: #EC7E74;vertical-align: top;            border-right-color: #EC7E74;            border-left-width: 0pt;            background: #EC7E74;            border-top-style: solid;            border-left-style: solid;            border-bottom-width: 0pt;            width: 196.3pt;            border-top-color: #EC7E74;            background: #EC7E74;            border-bottom-style: solid}" +
                        ".c4{border-right-style: solid;            border-bottom-color: #686664;            border-top-width: 0pt;            border-right-width: 0pt;            margin-top: 20pt;            border-left-color: #686664;            vertical-align: top;            margin-left: 15pt;            padding-left: 35pt;            border-right-color: #686664;            border-left-width: 0pt;            border-top-style: solid;            border-left-style: solid;            border-bottom-width: 0pt;            background: #686664;            width: 307.7pt;            border-top-color: #686664;            border-bottom-style: solid}" +
                        ...
                        ".c22{padding-bottom: 0pt;            color: #ffffff;            text-align: left}" +
                        ...
                        ".c17{height:265pt}" +
                        ".c91{   line-height: 1.15;            color: #313133;           brder-radius: 10pt;            font-family: \"helvetica\";            background: #686664}" +
                        ...
                        ".subtitle1{padding-top: 3pt;            color: #EC7E74;            font-weight: 700;            font-size: 16pt;            padding-bottom: 0pt;           font-family: \"Raleway\";            line-height: 1.0;            page-break-after: avoid;            orphans: 2;            margin-left: 20pt;            widows: 2;            text-align: left}" +
        ...
        if (modelMain.personInfo.imagePath.equals("")) {
            if (modelMain.personInfo.gender.equals("Male")) {
                htmlContent.append(
                    String.format(
                        "<p class=\"c68\"></p>" +
                                "<div style=\"margin-top: 35pt;height: 250px;margin-left: 20pt;margin-right: 20pt; background: #EC7E74;align-items: center;\">" +
            ...
            if (modelMain.skillsEntity != null) {
                htmlContent.append(
                    kotlin.String.format(
                        "" +
                                "                        <h1 class=\"c9\">" +
                                "                            <span class=\"c16\" style=\"margin-left: 20pt;\">Skills</span>" +
                                "                        </h1>" +
                                "                         <hr class=\"hr.new6\" style=\"width: 160pt;text-align: center;\">"
            ...
            htmlContent.append(
                String.format(
                    "" +
                            ...
                            "                        </h1>" +
                            "                            <hr class=\"hr.new6\" style=\"width: 160pt;text-align: center;\">" +
                            "                        <p class=\"c6\" style=\"margin-bottom: 15px;color: #ffffff\">" +
                            "                            <span class=\"c7\"  style=\"color: #000000\">%s</span>" +
                            "                        </p>" +
                            "                        <p class=\"c68\"></p>" +
                            "                        <p class=\"c68\"></p>",
                ...
                htmlContent.append(
                    String.format(
                        "" +
                                ...
                                "                            <span class=\"33 subtitle1\" style=\"text-decoration: underline;text-underline-position: under;\">  Work Experience  </span>" +
                                "                        </h1>" +
                                "" +
                                ""
                    ...
                    htmlContent.append(
                        String.format(
                            "" +
                                    ...
                                    "                            <span>" +
                                    "                                <p style=\"font-size: 12pt;color: #ffffff\">( %s )</p>" +
                                    "                            </span>" +
                                    "                        </h2>" +
                                    "                        <p class=\"c22\">" +
                                    "                            <span>" +
                                    "                                <p style=\"font-size: 10pt;color: #ffffff;margin-top: :2px;margin-bottom: 0px;margin-left: 28pt;font-weight:bold;\">%s</p>" +
                                    "                            </span>" +
                                    "                        </p>" +
                                    "                        <p class=\"c22\"><span>" +
                                    "                                <p style=\"color: #ffffff;font-size: 9pt;margin-top: 2px;margin-left: 28pt\">%s</p>" +
                                    "                        </p>" +
                                    "",
                ...
                htmlContent.append(
                    String.format(
                        "" +
                                ...
                                "                            <span class=\"33 subtitle1\" style=\"text-decoration: underline;text-underline-position: under;\">  Qualification  </span>" +
                                "                        </h1>" +
                                "" +
                                ""
                    ...
                    htmlContent.append(
                        String.format(
                            "" +
                                    ...
                                    "                        <p class=\"c22\">" +
                                    "                            <span>" +
                                    "                                <p style=\"font-size: 10pt;color: #ffffff;margin-top: :2px;margin-bottom: 0px;margin-left: 25pt;font-weight:bold; \">%s</p>" +
                                    "                            </span>" +
                                    "                        </p>" +
                                    "                        <p class=\"c22\">" +
                                    "                            <span>" +
                                    "                                <p style=\"font-size: 10pt;color: #ffffff;margin-top: 2px;margin-left: 25pt\">%s</p>" +
                                    "                            </span>" +
                                    "                        </p>" +
                                    "                        <p class=\"c22\">" +
                                    "                            <span>" +
            ...
            if (modelMain.projectsEntity != null) {
                htmlContent.append(
                    kotlin.String.format(
                        "" +
                                "<h1 class=\"c91\" >" +
                                "                            <span class=\"33 subtitle1\" style=\"margin-top: 10pt;text-decoration: underline;text-underline-position: under;\">  Projects  </span>" +
                                "                        </h1>"
                    )
                )
            }
        ...
        if (!tinyDB.getBoolean(Constants.skipInterest)) {
            htmlContent.append(
                String.format(
                    "" +
                            "<h1 class=\"c91\" >" +
                            "                            <span class=\"33 subtitle1\" style=\"margin-top: 10pt;text-decoration: underline;text-underline-position: under;\">  Interests  </span>" +
                            "                        </h1>" +
