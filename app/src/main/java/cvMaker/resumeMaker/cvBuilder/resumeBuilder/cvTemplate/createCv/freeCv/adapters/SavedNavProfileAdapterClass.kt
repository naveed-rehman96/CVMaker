...
class SavedNavProfileAdapterClass(
    val context: Context,
    private val arrayList: ArrayList<CVModelEntity>,
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        if (model.imagePath == "") {
            ...
            Glide.with(context).load(File(model.imagePath)).into(holder.personImage)
        }
    }
    ...
    inner class MyViewHolder constructor(itemView: View, private var onClickItem: SavedProfileClick) :
        ...
        override fun onClick(v: View?) {
            ...
            for (i in 0 until arrayList.size) {
                val product: CVModelEntity = arrayList[i]
