...
class PreviewDark_GrayWhiteActivity : AppCompatActivity() {
    ...
    private fun getOPFile(): File? {
        ...
        return File(mediaStorageDir.path + File.separator + modelMain.personInfo.fileName + "_DGW.jpg")
    }
    ...
    fun previewCV() {
        ...
        if (modelMain.personInfo.imagePath.equals("")) {
            if (modelMain.personInfo.gender.equals("Male")) {
                ...
                if (modelMain.personInfo.gender.equals("Female")) {
                    htmlContent.append(
                        String.format(
                            "<img src=\"%s\" style=\"width: 150px; height: 150px; margin-left: 10px; margin-top: 30px; border-radius: 100px; margin-right: 10px;\">\n",
                            female
            ...
            if (modelMain.projectsEntity != null) {
                htmlContent.append(
                    kotlin.String.format(
                        " <h1 class=\"c9\" style=\"text-align: center; margin-bottom: 15px;\">" +
                            "<span class=\"c16\" style=\"color: #0067DE; margin-bottom: 10px;text-align: center;\">Projects</span>\n" +
                            "                        </h1>\n" +
                            "\n"
                    )
                )
    ...
    private fun savePdf() {
        ...
        if (ActivityCompat.checkSelfPermission(
            ...
            val fileName = modelMain.personInfo.fileName + "_" + modelMain.personInfo.id + "_DGW.pdf"
