...
class ExperienceAdapterClass(
    val context1: Context,
    private val arrayList: List<ExperienceEntity>,
    var onClicked: onExperienceClickedListener
) :
    RecyclerView.Adapter<ExperienceAdapterClass.MyViewHolder>() {
...
//
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.CName.text = "Company :" + modelClass.companyName
        holder.designation.text = "Designation :" + modelClass.designation
        holder.todate.text = "From :" + modelClass.startDate
        holder.fromdate.text = "To :" + modelClass.endDate
        val number = position +1
        holder.itemNumber.text = "Experience $number"
