...
import cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.previewCvTemplateActivities.PreviewlightWhiteActivity
import java.io.File

class LightWhiteCVFragment : Fragment() {
        ...
        htmlContent.append(
            String.format(
                " <p class=\"c6\" style=\"margin-bottom: 15px;\"><span class=\"c7\">%s</span></p>" +
                        "                        <p class=\"68\"></p>", modelMain.personInfo.objective
