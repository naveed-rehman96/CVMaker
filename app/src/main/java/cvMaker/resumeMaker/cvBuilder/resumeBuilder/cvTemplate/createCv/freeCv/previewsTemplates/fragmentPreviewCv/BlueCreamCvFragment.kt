...
import cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.previewsTemplates.previewCvTemplateActivities.PreviewBlueCreamCreamActivity
import cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.ui.Constants
import java.io.File

class BlueCreamCvFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        dialog.show()
        cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.previewsTemplates.fragmentPreviewCv.BlueCreamCvFragment.Companion.modelMain = CvMainModel()
        cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.previewsTemplates.fragmentPreviewCv.BlueCreamCvFragment.Companion.modelMain = cvMainModel
    ...
    fun previewCV() {
        ...
        htmlContent.append(
            String.format(
                "                    <td class=\"c4\" colspan=\"1\" rowspan=\"1\">\n" +
                    ...
                    "                        <p class=\"c68\"></p>\n" +
                    "                        <p class=\"c68\"></p>\n",
                cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.previewsTemplates.fragmentPreviewCv.BlueCreamCvFragment.Companion.modelMain.personInfo.fullName,
                cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.previewsTemplates.fragmentPreviewCv.BlueCreamCvFragment.Companion.modelMain.personInfo.fatherName
        ...
        htmlContent.append(
            String.format(
                "<h1 class=\"c91\">" +
                    ...
                    "                            </span>" +
                    "                        </p>",
                cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.previewsTemplates.fragmentPreviewCv.BlueCreamCvFragment.Companion.modelMain.personInfo.objective
            )
        )
        ...
        if (!tinyDB.getBoolean(Constants.skipExp)) {
            ...
            if (cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.previewsTemplates.fragmentPreviewCv.BlueCreamCvFragment.Companion.modelMain.experienceInfo != null) {
                for (model in cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.previewsTemplates.fragmentPreviewCv.BlueCreamCvFragment.Companion.modelMain.experienceInfo!!) {
                    htmlContent.append(
                        String.format(
        ...
        if (!tinyDB.getBoolean(Constants.skipQua)) {
            if (cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.previewsTemplates.fragmentPreviewCv.BlueCreamCvFragment.Companion.modelMain.qualificationEntity != null) {
                htmlContent.append(
                    String.format(
                        "<h1 class=\"c91\" >" +
            ...
            if (cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.previewsTemplates.fragmentPreviewCv.BlueCreamCvFragment.Companion.modelMain.qualificationEntity != null) {
                for (model in cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.previewsTemplates.fragmentPreviewCv.BlueCreamCvFragment.Companion.modelMain.qualificationEntity!!) {
                    htmlContent.append(
                        String.format(
                            "<h2 class=\"c3\" style=\"font-size: 12px; margin-top: 2px;font-style: bold;margin-bottom: 5px;margin-left: 28pt\">\n" +
                                "                            <span>\n" +
        ...
        var file: File ? = null
        var name: String = ""
        if (!cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.previewsTemplates.fragmentPreviewCv.BlueCreamCvFragment.Companion.modelMain.personInfo.imagePath.equals("")) {
            file = File(cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.previewsTemplates.fragmentPreviewCv.BlueCreamCvFragment.Companion.modelMain.personInfo.imagePath)
            name = file.name
        }

        if (cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.previewsTemplates.fragmentPreviewCv.BlueCreamCvFragment.Companion.modelMain.personInfo.imagePath.equals("")) {
            if (cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.previewsTemplates.fragmentPreviewCv.BlueCreamCvFragment.Companion.modelMain.personInfo.gender.equals("Male")) {
                htmlContent.append(
                    String.format(
            ...
            } else if (cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.previewsTemplates.fragmentPreviewCv.BlueCreamCvFragment.Companion.modelMain.personInfo.gender.equals("Female")) {
                htmlContent.append(
                    String.format(
                        "           <th class=\"c26\" colspan=\"1\" rowspan=\"1\">\n" +
                            "                        <div style=\"height: 250px; background: #163C60;align-items: center;\">" +
        ...
        htmlContent.append(
            String.format(
                "<p class=\"c68\"></p>" +
                    ...
                    "" +
                    "",
                cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.previewsTemplates.fragmentPreviewCv.BlueCreamCvFragment.Companion.modelMain.personInfo.emailID,
                tinyDB.getString("FullPhoneNumberUpdate"),
                cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.previewsTemplates.fragmentPreviewCv.BlueCreamCvFragment.Companion.modelMain.personInfo.address,
                cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.previewsTemplates.fragmentPreviewCv.BlueCreamCvFragment.Companion.modelMain.personInfo.gender,
                cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.previewsTemplates.fragmentPreviewCv.BlueCreamCvFragment.Companion.modelMain.personInfo.dateOfBirth,
                cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.previewsTemplates.fragmentPreviewCv.BlueCreamCvFragment.Companion.modelMain.personInfo.cnic,
                cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.previewsTemplates.fragmentPreviewCv.BlueCreamCvFragment.Companion.modelMain.personInfo.nationality,
                "Status : " + cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.previewsTemplates.fragmentPreviewCv.BlueCreamCvFragment.Companion.modelMain.personInfo.maritalStatus
            )
        )

        if (!tinyDB.getBoolean(Constants.skipTech)) {
            if (cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.previewsTemplates.fragmentPreviewCv.BlueCreamCvFragment.Companion.modelMain.skillsEntity != null) {
                htmlContent.append(
                    String.format(
                        " <p class=\"68\"></p>" +
                            "                        <h1 class=\"c9\" style=\"text-align: center; margin-bottom: 15px;\">" +
                            "                            <span class=\"c16\" style=\"color: #ffffff; margin-bottom: 10px;text-align: center;\">Technical Skills</span>" +
                            "                            <hr class=\"new5\">" +
                            "                        </h1>"
                    )
                )
            ...
            if (cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.previewsTemplates.fragmentPreviewCv.BlueCreamCvFragment.Companion.modelMain.skillsEntity != null) {
                for (model in cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.previewsTemplates.fragmentPreviewCv.BlueCreamCvFragment.Companion.modelMain.skillsEntity!!) {
                    htmlContent.append(
                        String.format(
            ...
            htmlContent.append(
                String.format(
                    "<h1 class=\"c9\" style=\"text-align: center; margin-bottom: 15px;\">" +
                        ...
                        "                            <span class=\"c7\">%s</span>" +
                        "                        </p>",
                    cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.previewsTemplates.fragmentPreviewCv.BlueCreamCvFragment.Companion.modelMain.personInfo.language
        ...
        if (!tinyDB.getBoolean(Constants.skipProj)) {
            if (cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.previewsTemplates.fragmentPreviewCv.BlueCreamCvFragment.Companion.modelMain.projectsEntity != null) {
                htmlContent.append(
                    String.format(
                        "                        <p class=\"68\"></p>" +
                            "                        <h1 class=\"c9\" style=\"text-align: center; margin-bottom: 15px;\">" +
            ...
            if (cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.previewsTemplates.fragmentPreviewCv.BlueCreamCvFragment.Companion.modelMain.projectsEntity != null) {
                for (model in cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.previewsTemplates.fragmentPreviewCv.BlueCreamCvFragment.Companion.modelMain.projectsEntity!!) {
                    htmlContent.append(
                        String.format(
                            "                        <p class=\"c6\" style=\"margin-bottom: 2px;\">" +
                                "                            <span class=\"c7\">%s</span>" +
            ...
            htmlContent.append(
                String.format(
                    "                        <p class=\"68\"></p>" +
                        ...
                        "                            <span class=\"c7\">%s</span>" +
                        "                        </p>",
                    cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.previewsTemplates.fragmentPreviewCv.BlueCreamCvFragment.Companion.modelMain.personInfo.interest
            ...
            htmlContent.append(
                String.format(
                    "                        <p class=\"68\"></p>" +
                        ...
                        "                            <span class=\"c7\">%s</span>" +
                        "                        </p>",
                    cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.previewsTemplates.fragmentPreviewCv.BlueCreamCvFragment.Companion.modelMain.personInfo.awards
            ...
            htmlContent.append(
                String.format(
                    "                        <h1 class=\"c9\" style=\"text-align: center; margin-bottom: 15px;\">" +
                        ...
                        "                        </p>" +
                        "                        <p class=\"68\"></p>",
                    cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.previewsTemplates.fragmentPreviewCv.BlueCreamCvFragment.Companion.modelMain.personInfo.reference
