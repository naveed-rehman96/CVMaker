package cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.pdfPreview
       ...
       // pdfView = findViewById<View>(R.id.pdfView) as PDFView
        ...
        share.setOnClickListener(View.OnClickListener {
            ...
            val fileUri = FileProvider.getUriForFile(
                applicationContext,
                "cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.FileProvider", File(pdfFilePath)
            )
