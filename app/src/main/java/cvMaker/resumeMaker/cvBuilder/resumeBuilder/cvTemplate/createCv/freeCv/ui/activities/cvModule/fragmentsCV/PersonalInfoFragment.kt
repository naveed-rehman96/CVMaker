...
class PersonalInfoFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        confirm.setOnClickListener {
            ...
            cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.ui.activities.cvModule.CreateCVActivity.mViewPager2.currentItem = 1
        }
...
//
        ...
        if (TextUtils.isEmpty(phoneNumber)) {
            ...
            if (cCPicker.isValid) {
                ...
                cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.ui.activities.cvModule.CreateCVActivity.showMessage("You have entered and Invalid Number...")
                phoneNumEdt.error = "Invalid"
            }
        }
        ...
        if (TextUtils.isEmpty(emailid)) {
            ...
            if (!isValidEmail(emailid)) {
                cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.ui.activities.cvModule.CreateCVActivity.showMessage("Email Not Saved .. Please Type Correct Email ...")
                emailID.error = "Invalid"
            } else {
