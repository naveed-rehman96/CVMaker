package cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.ui.activities.cvModule
...
import cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.cvModule.fragmentsCV.*
...
import cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.ui.activities.previewCvTemplateActivities.*
import kotlinx.coroutines.launch
import org.koin.android.ext.android.inject

public class CreateCVActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        fun showMessage(message: String) {
            if (cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.ui.activities.cvModule.CreateCVActivity.Companion.mToast != null) {
                cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.ui.activities.cvModule.CreateCVActivity.Companion.mToast!!.cancel()
            }
            cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.ui.activities.cvModule.CreateCVActivity.Companion.mToast = Toast.makeText(
                cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.ui.activities.cvModule.CreateCVActivity.Companion.context, message, Toast.LENGTH_SHORT)
            cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.ui.activities.cvModule.CreateCVActivity.Companion.mToast!!.show()
        }
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.ui.activities.cvModule.CreateCVActivity.Companion.mViewPager2 = findViewById(R.id.viewpager2) // Get ViewPager2 view
        val adapter =
            cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.ui.activities.cvModule.CreateCVActivity.ViewPagerAdapter(
                this
            )
        cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.ui.activities.cvModule.CreateCVActivity.Companion.mViewPager2.adapter = adapter
        cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.ui.activities.cvModule.CreateCVActivity.Companion.mViewPager2.offscreenPageLimit = 5
        // Attach the adapter with our ViewPagerAdapter passing the host activity

        cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.ui.activities.cvModule.CreateCVActivity.Companion.mViewPager2.registerOnPageChangeCallback(object : ViewPager2.OnPageChangeCallback() {
        ...
        layoutPersonalInfo.setOnClickListener {
            txtPosition.text = "Position : 1/10"
            scroll1()
            cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.ui.activities.cvModule.CreateCVActivity.Companion.mViewPager2.setCurrentItem(0, false)
        }
        layoutObjective.setOnClickListener {
            scroll2()
            txtPosition.text = "Position : 2/10"
            cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.ui.activities.cvModule.CreateCVActivity.Companion.mViewPager2.setCurrentItem(1, false)
        }
        layoutExperience.setOnClickListener {
            txtPosition.text = "Position : 3/10"
            scroll3()
            cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.ui.activities.cvModule.CreateCVActivity.Companion.mViewPager2.setCurrentItem(2, false)
        }
        layoutQualification.setOnClickListener {
            txtPosition.text = "Position : 4/10"
            scroll4()
            cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.ui.activities.cvModule.CreateCVActivity.Companion.mViewPager2.setCurrentItem(3, false)
        }
        layoutTechnicalSkills.setOnClickListener {
            txtPosition.text = "Position : 5/10"
            scroll5()
            cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.ui.activities.cvModule.CreateCVActivity.Companion.mViewPager2.setCurrentItem(4, false)
        }
        layoutAchievements.setOnClickListener {
            txtPosition.text = "Position : 6/10"
            scroll6()
            cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.ui.activities.cvModule.CreateCVActivity.Companion.mViewPager2.setCurrentItem(5, false)
        }
        layoutProjects.setOnClickListener {
            txtPosition.text = "Position : 7/10"
            scroll7()
            cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.ui.activities.cvModule.CreateCVActivity.Companion.mViewPager2.setCurrentItem(6, false)
        }
        layoutInterest.setOnClickListener {
            txtPosition.text = "Position : 8/10"
            scroll8()
            cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.ui.activities.cvModule.CreateCVActivity.Companion.mViewPager2.setCurrentItem(7, false)
        }
        layoutLanguage.setOnClickListener {
            txtPosition.text = "Position : 9/10"
            scroll9()
            cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.ui.activities.cvModule.CreateCVActivity.Companion.mViewPager2.setCurrentItem(8, false)
        }
        layoutReference.setOnClickListener {
            scroll10()
            txtPosition.text = "Position : 10/10"
            cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.ui.activities.cvModule.CreateCVActivity.Companion.mViewPager2.setCurrentItem(9, false)
        }
    }
    ...
    private fun initializeViews() {
        cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.ui.activities.cvModule.CreateCVActivity.Companion.context = applicationContext
        ...
        return when (item.itemId) {
            R.id.viewCv -> {
                ...
                if (tinyDB12.getBoolean("IS_SELECTED")) {
                    ...
                    val intent = Intent(this, cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.ui.activities.cvModule.SelectTemplateActivity::class.java)
