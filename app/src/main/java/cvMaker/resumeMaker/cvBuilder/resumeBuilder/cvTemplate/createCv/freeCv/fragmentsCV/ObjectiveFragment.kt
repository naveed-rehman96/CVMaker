...
class ObjectiveFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        btnNext.setOnClickListener {
            cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.cvModule.CreateCVActivity.mViewPager2.setCurrentItem(2, true)
        }
        btnBack.setOnClickListener{
            cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.cvModule.CreateCVActivity.mViewPager2.setCurrentItem(0, true)
        }
