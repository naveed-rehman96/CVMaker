...
import cvMaker.resumeMaker.cvBuilder.resumeBuilder.cvTemplate.createCv.freeCv.previewCvTemplateActivities.PreviewDark_light_GrayActivity
import java.io.File
import java.lang.String


class DarkLightGrayCvFragment : Fragment() {
        ...
        if (!tinyDB.getBoolean(Constants.skipTech)) {
            ...
            if (modelMain.skillsEntity != null) {
                for (model in modelMain.skillsEntity!!) {
                    htmlContent.append(
                        java.lang.String.format(
                            " <p class=\"c6\" style=\"margin-bottom: 5px;\">" +
